                    ...
                    <ul>
                        ...
                        <li>
                            <a href={{ url('post/' . $headline->slug) }}>
                               <img src="http://fm786.com/public/uploads/images/logo.svg" style="width:50px;"> {{ $headline->title }}
 ...
 .lead-news {
  ...
  nav.navbar .navbar-brand img.logo {
    ...
    height: 14.75rem;
                                    ...
                                    <div class="post_desc p-t-10"><br>
                                      <div class="textp6" style="font-size: 16px;">
                                     {!! Str::limit($post->post_body, 170) !!}
</p>   
                ...
                <div class="col-xs-6 col-md-3 col-lg-3 p-b-20">
                    <a class="post-item bg-grey" href="{{ url('post', $post->slug) }}">
                        ...
                        <div class="post-content">
                            ...
                            <div class="title-holder">
                                <h3 class="post-title no-margin"> {!! Str::limit($post->title, 59) !!}</h3> 
                            </div>
                        </div>
                    </a>
                </div>
...
<div class="col-sm-12 hidden-xss">
<div class="p-b-10"><br>
...
<div class="title-holder"><br>
    <a href="{{ url('post', $post->slug) }}">
<h3 class="post-title no-margin">{!! Str::limit($post->title, 49) !!}</h3>
</a><br>
</div>
    ...
    @endif
	 @if(get_option('advertisement_big1_status', 0))
            ...
            <div class="row no-margin br-bottom p-b-20 p-t-20 p-r-20 br-top">
                        ...
                        <div class="row  video ">
                            <div class="col-xs-12 p-t-10">
                                <a class="post-item" href="{{ $post->video_url }}">
                                    ...
                                    <div class="p-b-10">
                                        <div class="title-holder p-t-10"><br>
                                            <h3 class="post-title no-margin p-b-10">{!! Str::limit($post->title, 80) !!}</h3>
                                          <div class="textp">
                                {!! Str::limit($post->post_body, 293) !!}
                                </div>
          </div>
                                        <div class="category-meta">
                                            <p class="category">
                ...
                <div class="col-xs-66 p-r-0 p-l-10">
                        ...
                        <div class="col-xs-66">
                            <a class="post-item bg-black" href="{{ url('post', $post->slug) }}">
                                ...
                                <div class="post-content">
                                    ...
                                    <div class="title-holder">
                                        <h3 class="post-title no-margin">{!! Str::limit($post->title, 55) !!} </h3>
            ...
            <div class="row ">
                ...
                <div class="col-xs-12 p-t-10">
                    <a class="post-item" href="{{ url('post', $post->slug) }}">
                        ...
                        <div class="p-b-10">
                            <div class="title-holder p-t-10"><br>
                                <h3 class="post-title no-margin p-b-10">{!! Str::limit($post->title, 100) !!}</h3>
                            </div>
                            <div class="category-meta">
                                <p class="category">
                                    @foreach($post->categories as $key => $categoryy)
            ...
            <div class="row ">
                ...
                <div class="col-xs-12 p-t-10">
                    <a class="post-item" href="{{ url('post', $post->slug) }}">
                        ...
                        <div class="p-b-10">
                            <div class="title-holder p-t-10"><br>
                                <h3 class="post-title no-margin p-b-10">  {!! Str::limit($post->title, 60) !!}</h3>
                            </div>
                            <div class="category-meta">
                                <p class="category">
                                    @foreach($post->categories as $key => $categoryy)
    ...
    <div class="row two-col-layout">
                    ...
                    <div class="col-left br-right p-l-20">
                        <div class="row">
                            <div class="col-xs-12"><br><br>
                                ...
                                <div class="section-title p-b-20">                                    <a href="{{ url('category/' . $category->slug) }}">
                                        <div class="p-b-10">
                                ...
                                <div class="top-news-3 p-l-20 p-r-20">
                                    ...
                                    <div class="post-item br-bottom m-b-20">
                                        <a href="{{ url('post', $post->slug) }}">
                                            <div class="post-content">
                                                <div class="title-holder">
                                                    <h3 class="no-margin no-padding">{!! Str::limit($post->title, 30) !!}</h3>
                                                </div>
        ...
        <div class="col-right">
            <div class="add-block" style="text-align:center;">
                @if(get_option('advertisement_fourmm_status', 0))
                        <div class="advert" style="margin-bottom:5px; padding-top: 5px;">
                            <div class="row ">
                                <div class="col-xs-12 p-t-10">
                                    <a class="post-item" href="{{ get_option('advertisement_fourmm_link', '#') }}">
                                        <figure class="img-holder">
                                            {!! get_option('advertisement_fourmm_content') !!}
                                        </figure>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="post-item br-bottom">
                            <a href="{{ url('post', $post->slug) }}">
                                ...
                                <div class="post-info">
                                    <h2 class="post-title">  {!! Str::limit($post->title, 60) !!}</h2>
                                    <div class="textp">
                                 {!! Str::limit($post->post_body, 100) !!}
                            ...
                            <div class="row ">
                                <div class="col-xs-12 p-t-10">
                                    <a class="post-item" href="{{ url('post', $post->slug) }}">
                                        ...
                                        <div class="p-b-10">
                                            <div class="title-holder p-t-10">
                                                <h3 class="post-title no-margin p-b-10">{!! Str::limit($post->title, 30) !!}</h3>
                                            </div></a>
                                            <div class="category-meta">
                                                <a href="category/{{ $category->slug }}">
...
<div class="container p-b-20 br-bottom p-t-20">
    ...
    -webkit-line-clamp:  !important;-webkit-box-orient: vertical;">
                                           {!! Str::limit($post->title, 60) !!}
                                        </h3> </a>
            ...
            <div class="row ">
                ...
                <div class="col-xs-12 p-t-10">
                    <a class="post-item" href="{{ url('post', $post->slug) }}">
                        ...
                        <div class="p-b-10">
                            <div class="title-holder p-t-10"><br>
                                <h3 class="post-title no-margin p-b-10">{!! Str::limit($post->title, 70) !!}</h3>
                            </div>
                            <div class="category-meta">
                                <p class="category">
                                    @foreach($post->categories as $key => $categoryy)
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                            <div class="grid-item">
                                ...
                                <h5><a href="{{ url('post', $post->slug) }}" class="title">{!! Str::limit($post->title, 50) !!}</a></h5>
                            </div>
                        </div>
                        @endforeach
                        @endif
...
<div class="container p-t-20 p-b-20 br-bottom">
    <div class="row">
        @php
        $post_categories2 = json_decode(get_option('post_categories2'));
        @endphp
        @if($post_categories2)
        @foreach($post_categories2 as $key => $post_category2)
        @php
        $category = App\Category::find($post_category2);
        $post_ids = App\PostCategory::where('category_id', $post_category2)->orderBy('id', 'DESC')->pluck('post_id')->toArray();
        @endphp
        @if($post_ids)
        @php
        $post = App\Post::where('id', $post_ids[0])->orderBy('id', 'DESC')->first();
...
<div class="container p-t-20 p-b-20 br-bottom">
    <div class="row">
        @php
        $post_categories3 = json_decode(get_option('post_categories3'));
        @endphp
        @if($post_categories2)
        @foreach($post_categories3 as $key => $post_category3)
        @php
        $category = App\Category::find($post_category3);
        $post_ids = App\PostCategory::where('category_id', $post_category3)->orderBy('id', 'DESC')->pluck('post_id')->toArray();
        @endphp
        @if($post_ids)
        @php
        $post = App\Post::where('id', $post_ids[0])->orderBy('id', 'DESC')->first();
...
<div class="container p-t-20 p-b-20 br-bottom">
    <div class="row">
        @php
        $post_categories4 = json_decode(get_option('post_categories4'));
        @endphp
        @if($post_categories4)
        @foreach($post_categories4 as $key => $post_category4)
        @php
        $category = App\Category::find($post_category4);
        $post_ids = App\PostCategory::where('category_id', $post_category4)->orderBy('id', 'DESC')->pluck('post_id')->toArray();
        @endphp
        @if($post_ids)
        @php
        $post = App\Post::where('id', $post_ids[0])->orderBy('id', 'DESC')->first();
                ...
                <div class="post-items p-b-20 p-t-20 br-bottom">
                   ...
                   @php
                    $trending_posts = App\Post::select("posts.*", "post_views.views")
                                                ...
                                                ->limit(get_option('trending_limit', 2))
                                                ->get();
                    @endphp
                    ...
                    <div class="post-item col-sm-3">
                        <a href="{{ url('post', $post->slug) }}">
                            ...
                            <h3 class="post-title"> {!! Str::limit($post->title, 40) !!}</h3>
                            </a>
