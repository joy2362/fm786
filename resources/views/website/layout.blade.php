...
<html lang="en">
<head>
<script data-ad-client="ca-pub-9720414846756536" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<meta property="fb:pages" content="888090324728472" />
<meta charset="utf-8">
...
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>FM786 is a Community News Network</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    background-color: #eee;
                    ...
                    <div class="col-sm-8 pull-right">
                        <div class="header-right-menu">
                            <ul>
                                 <li class="bg-black"><a style="color: black ;background: #ff0000; font-size: 15px" href="http://beta.fm786.com/converter/">Bangla Converter</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="header-mid hidden-xs">
            <div class="container">
                <div class="row" style="display:flex; justify-content: left">
                    <div class="header-right-menu">
                       <p class="p-t-51" style="  padding-top: 5px;
...
?>
                    ...
                    <div class="logo">
                        <a href="{{ url('/') }}">
                            <img src="{{ asset('public/uploads') }}/images/logo.svg" class="img-responsive" alt="FM786 is a Community News Network">
                        </a>
                    </div>
